...
def run_scraper(source, keywords_file, save_dir, images_per_source):
    ...
    script_map = {
        ...
        "pinterest": "phase1_foundation/scripts/scrapers/image_scraper_pinterest_hindi.py",
        "getty-images": "phase1_foundation/scripts/scrapers/image_scraper_getty_hindi.py",
        "flickr": "phase1_foundation/scripts/scrapers/image_scraper_flickr_commons_hindi.py",
        "yahoo": "phase1_foundation/scripts/scrapers/image_scraper_yahoo_hindi.py"
    }
...
def run_ocr(input_dir, output_dir):
    ...
    subprocess.run([
        "python3", "phase1_foundation/scripts/ocr/filter_images_hindi_ocr.py",
        "--input_dir", input_dir,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="📊 Hindi Dataset Pipeline")
    parser.add_argument("--keywords", type=str, required=True)
    parser.add_argument("--images_per_source", type=int, default=5)
    parser.add_argument("--raw_dir", type=str, default="data/raw_hindi")
    parser.add_argument("--processed_dir", type=str, default="data/processed_hindi")
    parser.add_argument("--zip_path", type=str, default="data/hindi_dataset.zip")

    args = parser.parse_args()

    # Step 1: Scraping
    for src in ["bing", "google", "pinterest", "getty-images", "flickr", "yahoo"]:
    ...
    print("✅ Hindi pipeline completed.")