...
def run_ocr(input_dir, output_dir):
    print("🔍 Running OCR filtering for Bengali...")
    subprocess.run([
        "python3", "phase1_foundation/scripts/ocr/filter_images_bengali_ocr.py",
        "--input_dir", input_dir,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="📊 Bengali Image Dataset Pipeline")
    parser.add_argument("--keywords", type=str, required=True)
    parser.add_argument("--images_per_keyword", type=int, default=5)
    parser.add_argument("--raw_dir", type=str, default="data/raw_bengali")
    parser.add_argument("--processed_dir", type=str, default="data/processed_bengali")
    parser.add_argument("--zip_path", type=str, default="data/bengali_dataset.zip")
    ...
    print("✅ Bengali dataset pipeline completed.")