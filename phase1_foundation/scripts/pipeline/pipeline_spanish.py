...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="📊 Spanish Image Dataset Pipeline")
    parser.add_argument("--keywords", type=str, required=True)
    parser.add_argument("--images_per_keyword", type=int, default=5)
    parser.add_argument("--raw_dir", type=str, default="data/raw_spanish")
    parser.add_argument("--processed_dir", type=str, default="data/processed_spanish")
    parser.add_argument("--zip_path", type=str, default="data/spanish_dataset.zip")

    args = parser.parse_args()

    for src in [
        "google", "bing", "duckduckgo", "pinterest", "stock_sites"
    ]:
    ...
    print("✅ Spanish dataset pipeline completed.")