...
def run_ocr_filter(input_dir, output_dir, annotation_path):
    ...
    for idx, img_path in enumerate(tqdm(valid_files, desc="🔍 OCR Processing", unit="image")):
        try:
            ...
            portuguese_text = " ".join([line for line in results if line.strip()])
            ...
            if portuguese_text:
                ...
                annotations[new_filename] = portuguese_text
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="OCR Filter for Portuguese Images")
