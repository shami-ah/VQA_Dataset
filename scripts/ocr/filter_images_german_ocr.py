...
def is_german(text):
    # Check for presence of German-specific characters or words
    german_chars = re.findall(r'[äöüßÄÖÜ]', text)
    common_words = re.findall(r'\b(der|die|das|und|ist|nicht|ein|eine|ich|wir|sie|mit|für|auf|haben)\b', text.lower())
    return len(german_chars) + len(common_words) >= 3
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="German OCR Image Filter")
